...
const SocialCard = ({name, image, source_link}) => {
    return <>
        ...
        <Tilt>
            <img src={image} alt={name} className='sm:w-28  w-20 cursor-pointer' onClick={() => window.open(source_link, "_blank")}/>
        </Tilt>
...
const Social = () => {
  return (
    ...
    <div className='mt-20 flex flex-wrap sm:gap-20 gap-10 justify-center w-3/4 m-auto -ml-2'>
